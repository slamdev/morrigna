...
public class Assets {
    ...
    static Texture itemSelector, buttons, character, material, tree, hydration, bucket, corn, farm, houseIn, craftmenu,
    ...
    static TextureRegion upChar_STILL, upChar_LEFT, upChar_RIGHT, downChar_STILL, downChar_LEFT, downChar_RIGHT,
            leftChar_STILL, leftChar_LEFT, leftChar_RIGHT, rightChar_STILL, rightChar_LEFT, rightChar_RIGHT, mainChar,
            upCreeper_STILL, upCreeper_LEFT, upCreeper_RIGHT, downCreeper_STILL, downCreeper_LEFT, downCreeper_RIGHT,
            leftCreeper_STILL, leftCreeper_LEFT, leftCreeper_RIGHT, rightCreeper_STILL, rightCreeper_LEFT,
            rightCreeper_RIGHT, mainCreeper, upRobot_STILL, upRobot_LEFT, upRobot_RIGHT, downRobot_STILL,
            downRobot_LEFT, downRobot_RIGHT, leftRobot_STILL, leftRobot_LEFT, leftRobot_RIGHT, rightRobot_STILL,
            rightRobot_LEFT, rightRobot_RIGHT, mainRobot, upPig_STILL, upPig_LEFT, upPig_RIGHT, downPig_STILL,
            downPig_LEFT, downPig_RIGHT, leftPig_STILL, leftPig_LEFT, leftPig_RIGHT, rightPig_STILL, rightPig_LEFT,
            rightPig_RIGHT, mainPig, upWolf_STILL, upWolf_LEFT, upWolf_RIGHT, downWolf_STILL, downWolf_LEFT,
            downWolf_RIGHT, leftWolf_STILL, leftWolf_LEFT, leftWolf_RIGHT, rightWolf_STILL, rightWolf_LEFT,
            rightWolf_RIGHT, mainWolf;
    ...
    public static void load() {
        ...
        treeSkeletonData = treeJson.readSkeletonData(Gdx.files.internal("data/tree.json"));
        ...
        leaveSkeletonData = leavesJson.readSkeletonData(Gdx.files.internal("data/leavesSkel.json"));
        leaveAnim = leaveSkeletonData.findAnimation("animation");
        toolsMasterAtlas = new TextureAtlas(Gdx.files.internal("data/toolAtlas.atlas"));
        SkeletonJson toolsMasterJson = new SkeletonJson(toolsMasterAtlas);
        toolsMasterData = toolsMasterJson.readSkeletonData(Gdx.files.internal("data/toolsMaster.json"));
        toolsMasterAnim = toolsMasterData.findAnimation("animation");
        cgfFont = new BitmapFont(Gdx.files.internal("data/cgf.fnt"), Gdx.files.internal("data/cgf_0.png"), false);
        // maps
