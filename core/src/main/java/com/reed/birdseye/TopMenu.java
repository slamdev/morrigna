...
public class TopMenu {
    ...
    void input() {
        ...
        if (Gdx.input.getY() < 74 && Gdx.input.getY() > 0 && Gdx.input.getX() > 230 && Gdx.input.getX() < 310
                && Gdx.input.isTouched()) {
            currentTool = 0;
        }
        if (Gdx.input.getY() < 74 && Gdx.input.getY() > 0 && Gdx.input.getX() > 310 && Gdx.input.getX() < 390
                && Gdx.input.isTouched()) {
            currentTool = 1;
        }
        if (Gdx.input.getY() < 74 && Gdx.input.getY() > 0 && Gdx.input.getX() > 390 && Gdx.input.getX() < 470
                && Gdx.input.isTouched()) {
            currentTool = 2;
        }
        if (Gdx.input.getY() < 74 && Gdx.input.getY() > 0 && Gdx.input.getX() > 470 && Gdx.input.getX() < 550
                && Gdx.input.isTouched()) {
            currentTool = 3;
        }
        if (Gdx.input.getY() < 74 && Gdx.input.getY() > 0 && Gdx.input.getX() > 550 && Gdx.input.getX() < 630
                && Gdx.input.isTouched()) {
            currentTool = 4;
        }
    }
