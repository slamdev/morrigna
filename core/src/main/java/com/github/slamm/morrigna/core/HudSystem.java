...
public class HudSystem {
    ...
    public static class TradeShop extends InputAdapter {
        ...
        private static boolean closeEnough() {
            return Math.sqrt((TradeShopOwner.X - Player.x) * (TradeShopOwner.X - Player.x)
                    + (TradeShopOwner.Y - Player.y) * (TradeShopOwner.Y - Player.y)) < DISTANCE_FROM_SHOP;
        }
    ...
    public HudSystem(SpriteBatch batch, OrthographicCamera camera, Points points, BitmapFont currentFont) {
        this.batch = batch;
        this.camera = camera;
        this.points = points;
        ...
        multiplexer.addProcessor(tradeShop);
    ...
    public void render(float delta) {
        ...
        tradeShop.render(currentFont, batch);
