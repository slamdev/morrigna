...
public class CollisionDetection {
    ...
    private static void mapCollision() {
        ...
        else if (Player.y < 2258 && Player.y > 1192 && Player.x > 1466 && Player.x < 1502) {
            Player.isAbleToMoveLeft = false;
        }// segment 56
        else if (Player.y < 1952 && Player.y > 1186 && Player.x > 2748 && Player.x < 2780) {
            Player.isAbleToMoveLeft = false;
        } else {
        ...
        else if (Player.y < 2260 && Player.y > 1930 && Player.x > 2628 && Player.x < 2696) {
            Player.isAbleToMoveRight = false;
        }// segment 23
        ...
        else if (Player.y < 2258 && Player.y > 1192 && Player.x > 1456 && Player.x < 1492) {
            Player.isAbleToMoveRight = false;
        }// segment 56
        else if (Player.y < 1952 && Player.y > 1186 && Player.x > 2738 && Player.x < 2770) {
            Player.isAbleToMoveRight = false;
        } else {
        ...
        else if (Player.y > 1932 && Player.y < 1960 && Player.x > 2738 && Player.x < 3836) {
            Player.isAbleToMoveDown = false;
        }// segment 22
        ...
        else if (Player.y > 1198 && Player.y < 1222 && Player.x > 1460 && Player.x < 2776) {
            Player.isAbleToMoveDown = false;
        } else {
        ...
        else if (Player.y > 1922 && Player.y < 1950 && Player.x > 2738 && Player.x < 3836) {
            Player.isAbleToMoveUp = false;
        }// segment 22
        ...
        // segment 55
        else if (Player.y > 1188 && Player.y < 1208 && Player.x > 1460 && Player.x < 2776) {
            Player.isAbleToMoveUp = false;
        } // segment 55
        else if (Player.y > 1924 && Player.y < 1938 && Player.x > 2632 && Player.x < 2698) {
            Player.isAbleToMoveUp = false;
        } else {
